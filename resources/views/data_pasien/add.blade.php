...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
    <div class="col-12">
<form action="{{ route('data_pasien.simpan') }}" method="post">
  @csrf
  @if ($errors->any())
...
@endif
  ...
  <div class="mb-3">
    ...
    <input type="string" class="form-control" id="no_reg" name="no_registrasi" required>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="tel" class="form-control" id="phone" name="no_telepon" pattern="[0-9]{12,13}" title="Nomor telepon harus terdiri dari 12-13 digit angka" required>
